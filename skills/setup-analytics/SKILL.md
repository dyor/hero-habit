...
`shared/src/commonMain/kotlin/com/koko/habittracker/util/analytics/Analytics.kt`.
...
(`shared/src/commonMain/kotlin/com/koko/habittracker/data/source/featureflag/FeatureFlagManager.kt`),
...
Use `AppLogger`
(the facade declared in `shared/src/commonMain/kotlin/com/koko/habittracker/util/logging/Logger.kt`
