...
`shared/src/commonMain/kotlin/com/koko/habittracker/root/AppConfiguration.kt` — the toggles/values a
...
`shared/src/commonMain/kotlin/com/koko/habittracker/util/Constants.kt` (unlikely to change per app):
