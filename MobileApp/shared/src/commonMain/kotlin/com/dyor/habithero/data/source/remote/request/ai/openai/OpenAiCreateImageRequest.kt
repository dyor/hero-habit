package com.dyor.habithero.data.source.remote.request.ai.openai
...
data class OpenAiCreateImageRequest(
    ...
    @SerialName("output_format") val outputFormat: String? = null, // png, jpeg, or webp. Supported only for gpt-image-1
)
