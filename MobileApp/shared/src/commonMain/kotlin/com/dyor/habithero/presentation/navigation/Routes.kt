...
data class CelebrationScreenRoute(
    val habitId: String = "",
    val habitTitle: String = "Daily Quest",
    val streakCount: Int = 1,
) : ScreenRoute

@Serializable
@SerialName("HabitDetail")
data class HabitDetailScreenRoute(val habitId: String) : ScreenRoute
