...
package com.dyor.habithero.util.logging
...
// Logger that forwards ERROR/INFO logs to a Telegram chat (handy for remote crash/usage alerts).
// No-op until TELEGRAM_BOT_TOKEN + TELEGRAM_CHAT_ID are set (see companion).
