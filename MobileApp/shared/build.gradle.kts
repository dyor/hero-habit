...
kotlin {
    ...
    android {
        namespace = "com.dyor.habithero.shared"
    ...
    listOf(
        ...
        it.binaries.framework {
            ...
            binaryOption("bundleId", "com.dyor.habithero.shared")
        }
    }
...
compose.resources {
    packageOfResClass = "com.dyor.habithero.generated.resources"
}
...
buildConfig {
    ...
    packageName("com.dyor.habithero.common")
