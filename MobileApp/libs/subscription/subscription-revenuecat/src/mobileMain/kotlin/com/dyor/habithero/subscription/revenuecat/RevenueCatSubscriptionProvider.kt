...
internal class RevenueCatSubscriptionProvider : SubscriptionProvider {
    ...
    private fun Period.periodUnit(): com.dyor.habithero.subscription.api.PeriodUnit? = when (unit) {
        PeriodUnit.DAY -> com.dyor.habithero.subscription.api.PeriodUnit.DAY
        PeriodUnit.WEEK -> com.dyor.habithero.subscription.api.PeriodUnit.WEEK
        PeriodUnit.MONTH -> com.dyor.habithero.subscription.api.PeriodUnit.MONTH
        PeriodUnit.YEAR -> com.dyor.habithero.subscription.api.PeriodUnit.YEAR
        PeriodUnit.UNKNOWN -> null
    }
